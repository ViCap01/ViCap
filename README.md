...
For the weak supervision with only prompts, we devise a method which uses the output of the decoder to reconstruct the input of the decoder. As shown below, we illustrate the structure of GRU reconstruction network.
...
*Qualitative results generated by our convolutional decoder. And the model is trained in the form of full supervision. "Initial" indicates the initial caption generated by the S2VT model. "GT" indicates the ground-truth. The red words indicate the final generated words.*
